...
/**
 * Form request for bulk verifying multiple connections during audit execution.
 *
 * Requires an array of verification IDs that exist in the database.
 */
class BulkVerifyRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'verification_ids.*' => ['required', 'integer', 'exists:audit_connection_verifications,id'],
        ];
    }
    ...
    {
        return [
            'verification_ids.required' => 'Please select at least one connection to verify.',
            'verification_ids.array' => 'Invalid selection format.',
            'verification_ids.min' => 'Please select at least one connection to verify.',
            'verification_ids.max' => 'Cannot bulk verify more than 100 connections at once.',
