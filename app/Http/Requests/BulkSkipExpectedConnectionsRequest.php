...
/**
 * Form request for bulk skipping expected connections.
 *
 * Validates an array of connection IDs for batch status update to skipped.
 */
class BulkSkipExpectedConnectionsRequest extends FormRequest
{
    /**
