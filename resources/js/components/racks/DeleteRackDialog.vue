...
const handleDelete = () => {
    ...
    router.delete(RackController.destroy.url({
        ...
        <DialogContent>
            <DialogHeader class="space-y-3">
                ...
                <DialogDescription>
                    ...
                    <span class="font-semibold">{{ rackName }}</span>?
            ...
            >
                <div class="relative space-y-0.5 text-red-600 dark:text-red-100">
                    ...
                    <p class="text-sm">
                        The rack will be permanently removed from the system.
                    </p>
                    <p v-if="hasPdus" class="text-sm font-medium">
                        PDUs assigned to this rack will be detached but not deleted.
                    </p>
                </div>
            </div>
            ...
            <DialogFooter class="gap-2">
                ...
                <Button
                    ...
                    @click="handleDelete"
                >
                    {{ isDeleting ? 'Deleting...' : 'Delete Rack' }}
                </Button>
            </DialogFooter>
        </DialogContent>
    </Dialog>
