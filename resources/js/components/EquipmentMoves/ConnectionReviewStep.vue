...
import { Cable, Server, ArrowRight, AlertTriangle, CheckCircle } from 'lucide-vue-next';
...
function getCableColorStyle(color: string | null): Record<string, string> {
    ...
    const colorMap: Record<string, { bg: string; text: string }> = {
        blue: { bg: 'bg-blue-100 dark:bg-blue-900/30', text: 'text-blue-800 dark:text-blue-400' },
        red: { bg: 'bg-red-100 dark:bg-red-900/30', text: 'text-red-800 dark:text-red-400' },
        green: { bg: 'bg-green-100 dark:bg-green-900/30', text: 'text-green-800 dark:text-green-400' },
        yellow: { bg: 'bg-yellow-100 dark:bg-yellow-900/30', text: 'text-yellow-800 dark:text-yellow-400' },
        orange: { bg: 'bg-orange-100 dark:bg-orange-900/30', text: 'text-orange-800 dark:text-orange-400' },
        purple: { bg: 'bg-purple-100 dark:bg-purple-900/30', text: 'text-purple-800 dark:text-purple-400' },
        black: { bg: 'bg-gray-800 dark:bg-gray-700', text: 'text-white' },
        white: { bg: 'bg-gray-100 dark:bg-gray-300', text: 'text-gray-800' },
        gray: { bg: 'bg-gray-100 dark:bg-gray-600', text: 'text-gray-800 dark:text-gray-200' },
    };

    return colorMap[color.toLowerCase()] || { bg: 'bg-muted', text: 'text-foreground' };
}
    ...
    <div class="space-y-6">
        <div>
            ...
            <p class="text-sm text-muted-foreground">
                Review all active connections on this device. These connections will be disconnected
        ...
        >
            ...
            <p class="mt-2 text-sm text-muted-foreground">
                This device has no active connections that need to be disconnected.
            </p>
        </div>
        ...
        <template v-else>
            <Alert>
                ...
                <AlertDescription>
                    ...
                    will be automatically disconnected when this move is approved.
                </AlertDescription>
            </Alert>
                            ...
                            <div class="flex shrink-0 flex-col items-center gap-1">
                                <div class="flex items-center gap-2">
                                    <Badge
                                        ...
                                        class="text-xs"
                                    >
                                        {{ formatCableType(connection.cable_type) }}
                                    </Badge>
                                ...
                                <div class="flex items-center gap-1">
                                    <div
                                        ...
                                        :class="getCableColorStyle(connection.cable_color).bg"
                                        :title="connection.cable_color"
                                    />
                                    <span v-if="connection.cable_length" class="text-xs text-muted-foreground">
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1">
                        <Label
                            ...
                            class="cursor-pointer text-sm font-medium leading-tight"
                        >
                        ...
                        <p class="mt-1 text-xs text-muted-foreground">
                            ...
                            listed above will be automatically disconnected when the move is approved.
                            Connection details will be preserved in the move history for documentation.
                        </p>
                    </div>
                </div>
            </div>
