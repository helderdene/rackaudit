...
const formAction = computed(() => {
    if (props.mode === 'create') {
        return {
            action: PduController.store.url({
    ...
    return {
        action: PduController.update.url({
            datacenter: props.datacenter.id,
            room: props.room.id,
            pdu: props.pdu.id!,
        }),
    ...
    >
        ...
        <div class="space-y-4">
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                ...
                <div class="grid gap-2">
                    <Label for="phase"
                        >Phase <span class="text-red-500">*</span></Label
                    >
                    <select
                        id="phase"
                        name="phase"
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                <div class="grid gap-2">
                    ...
                    <p class="text-xs text-muted-foreground">
                        Select "Room Level" to assign PDU to the entire room, or
