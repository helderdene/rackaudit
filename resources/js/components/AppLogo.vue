...
<template>
    <div class="flex aspect-square size-8 items-center justify-center rounded-md bg-sky-600 dark:bg-sky-500 text-white">
    ...
    <div class="ml-1 grid flex-1 text-left text-sm">
        <span class="mb-0.5 truncate leading-tight font-semibold font-mono">RackAudit</span>
    </div>
</template>
