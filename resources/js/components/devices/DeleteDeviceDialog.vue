...
import { destroy } from '@/actions/App/Http/Controllers/DeviceController';
...
const handleDelete = () => {
    ...
    router.delete(destroy.url(props.deviceId), {
        preserveScroll: true,
        onSuccess: () => {
            isOpen.value = false;
        ...
        <DialogContent>
            ...
            >
                <div class="relative space-y-0.5 text-red-600 dark:text-red-100">
                    ...
                    <p class="text-sm">
                        The device will be permanently removed from the system.
