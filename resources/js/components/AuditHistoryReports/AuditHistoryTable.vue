...
const paginationLinks = computed((): PaginationLink[] => {
    ...
    links.push({
        url:
            current_page > 1
                ? `${baseUrl}?page=${current_page - 1}&${new URLSearchParams(params as Record<string, string>).toString()}`
                : null,
                            ...
                            <tr>
                                ...
                                >
                                    ...
                                    >
                                        Completed
                                        <component
                                            :is="getSortIcon('completion_date')"
                                            class="size-4"
                                        />
                                    </button>
                                </th>
                                ...
                                >
                                    <button
                                        class="flex items-center gap-1 hover:text-foreground"
                                        @click="
                                            handleSort('avg_resolution_time')
                                        "
                                    >
                                        Avg Resolution
                                        <component
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td class="p-4">
                                    <Badge
                                        :variant="
                                            getTypeBadgeVariant(audit.type)
                                        "
                                    >
                                        {{ audit.type_label }}
                                    </Badge>
                                ...
                                <td class="p-4">
                                    <div class="flex flex-wrap gap-1">
                                        <span
                                            v-if="
                                                audit.severity_counts.critical >
                                                0
                                            "
