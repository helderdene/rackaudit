...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td class="p-4 text-muted-foreground">
                                    <span v-if="exportItem.status === 'pending'"
                                        >-</span
                                    >
                                    <span v-else>
                                        {{
                                            formatProgress(
                                                exportItem.processed_rows,
            ...
            <!-- Pagination -->
            <div
                v-if="exports.last_page > 1"
                class="flex items-center justify-between"
            >
                <p class="text-sm text-muted-foreground">
                    Showing
                    {{ (exports.current_page - 1) * exports.per_page + 1 }} to
                    {{
                        Math.min(
                            exports.current_page * exports.per_page,
                            exports.total,
                        )
                    }}
