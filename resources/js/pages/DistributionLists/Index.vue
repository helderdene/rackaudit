...
import { Mail, Pencil, Plus, Trash2, Users } from 'lucide-vue-next';
import { ref } from 'vue';
        ...
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            ...
            >
                ...
                <p class="mt-1 text-center text-sm text-muted-foreground">
                    Create a distribution list to organize email recipients for
                    scheduled reports.
                </p>
            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        ...
                        {{ listToDelete?.members_count }} member(s) will be
