...
import {
    ...
    edit,
    show,
} from '@/actions/App/Http/Controllers/DeviceController';
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        ...
                        <tbody>
                            ...
                            <tr
                                v-if="
                                    (devices.data as DeviceData[]).length === 0
                                "
                            >
                                <td
                                    colspan="7"
            ...
            <!-- Pagination -->
            <div
                v-if="devices.last_page > 1"
                class="flex items-center justify-between"
            >
                <p class="text-sm text-muted-foreground">
                    Showing
                    {{ (devices.current_page - 1) * devices.per_page + 1 }} to
                    {{
                        Math.min(
                            devices.current_page * devices.per_page,
                            devices.total,
                        )
                    }}
