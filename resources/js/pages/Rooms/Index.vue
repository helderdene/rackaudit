        ...
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            ...
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <Link v-if="canCreate" :href="RoomController.create.url(datacenter.id)">
                    ...
                    <table class="w-full text-sm">
                        <thead class="border-b bg-muted/50">
                            <tr>
                                ...
                                <th class="h-12 px-4 text-left font-medium text-muted-foreground">Row Count</th>
                                <th class="h-12 px-4 text-left font-medium text-muted-foreground">Rack Count</th>
                            ...
                            >
                                ...
                                <td class="p-4">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <Link :href="RoomController.edit.url({ datacenter: datacenter.id, room: room.id })">
            ...
            <!-- Pagination -->
            <div v-if="rooms.last_page > 1" class="flex flex-col items-center justify-between gap-4 sm:flex-row">
                <div class="text-sm text-muted-foreground">
                    Showing {{ (rooms.current_page - 1) * rooms.per_page + 1 }} to
                    {{ Math.min(rooms.current_page * rooms.per_page, rooms.total) }} of
                    {{ rooms.total }} rooms
                </div>
