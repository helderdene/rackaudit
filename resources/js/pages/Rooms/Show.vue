...
import { Building2, LayoutGrid, Ruler, Zap } from 'lucide-vue-next';
                    ...
                    <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div class="grid gap-2">
                            ...
                            <dd class="text-sm">
                                {{
                                    room.square_footage
                                        ? `${room.square_footage.toLocaleString()} sq ft`
                                        : '-'
                                }}
                            </dd>
                        </div>
                        ...
                        <div
                            ...
                            class="grid gap-2 sm:col-span-2 lg:col-span-4"
                        >
                            <dt
                                class="text-sm font-medium text-muted-foreground"
                            >
                            ...
                            <table class="w-full text-sm">
                                <thead class="border-b bg-muted/50">
                                    <tr>
                                        ...
                                        <th
                                            class="h-10 w-[140px] px-4 text-left font-medium text-muted-foreground"
                                        >
                                            Actions
                                        </th>
                                    </tr>
