...
const tourStepArticles = computed(() => {
    return props.availableArticles.filter(
        (a) => a.article_type === 'tour_step',
    );
});
...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        <Head
            :title="mode === 'create' ? 'Create Help Tour' : 'Edit Help Tour'"
        />
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-muted-foreground">
                            {{
                                mode === 'create'
                                    ? 'Create a new step-by-step tour for users.'
                                    : 'Update the tour details and steps.'
                            }}
                        </p>
                    </div>
                </div>
            ...
            <div class="grid gap-6 lg:grid-cols-2">
                ...
                <Card>
                    ...
                    <CardContent>
                                ...
                                <div class="grid gap-4">
                                    <div class="space-y-2">
                                        ...
                                        >
                                            ...
                                            <option
                                                v-for="article in tourStepArticles"
                                                :key="article.id"
                                                :value="article.id"
                                            >
                                                {{ article.title }}
                                    ...
                                    <div class="grid gap-4 sm:grid-cols-2">
                                        <div class="space-y-2">
                                            ...
                                            >
                                                CSS selector for the element to
                                                highlight
                                            </p>
                                        </div>
                        ...
                        <div
                            v-if="tourStepArticles.length === 0"
                            class="mt-4 rounded-lg border border-orange-200 bg-orange-50 p-4 dark:border-orange-900 dark:bg-orange-950"
                        >
                            <p
                                class="text-sm text-orange-800 dark:text-orange-200"
                            >
                                No "tour_step" type articles found. Create some
                                articles with type "Tour Step" first to use in
                                tours.
                            </p>
                            <Link
                                href="/admin/help/articles/create"
                                class="mt-2 inline-block text-sm font-medium text-orange-600 hover:underline dark:text-orange-400"
                            >
