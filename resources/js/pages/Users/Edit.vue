    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
            ...
            <div v-if="!isCurrentUser" class="max-w-xl space-y-6">
                ...
                >
                    ...
                    >
                        ...
                        <p class="text-sm">
                            Once deleted, this user will no longer be able to
                            access the system. This action cannot be undone.
                        </p>
                    </div>
                    <DeleteUserDialog :user-id="user.id" :user-name="user.name">
            ...
            <div v-else class="max-w-xl">
                ...
                >
                    <div
                        class="relative space-y-0.5 text-blue-700 dark:text-blue-100"
                    >
                        <p class="font-medium">Note</p>
                        <p class="text-sm">
                            You are editing your own account. Some restrictions
                            apply:
                        </p>
